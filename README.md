...
> [!IMPORTANT]
> **This is `deer-flow-quickstart`, a deployment-focused fork of [bytedance/deer-flow](https://github.com/bytedance/deer-flow).**
>
> It tracks upstream DeerFlow 2.x and adds one thing: **you can deploy it before you have any API keys.**
> No `OPENAI_API_KEY`, no `TAVILY_API_KEY`, nothing in the environment. Deploy, open the app,
> create your admin account, then add credentials for any of 30+ model providers from
> **Settings → Providers**. Keys are stored encrypted in Postgres, so they survive every redeploy,
> and new models are live on the next request — no restart.
>
...
>
> **[Quickstart guide](./QUICKSTART.md)** · **[Railway setup](./deploy/railway/README.md)** · **[Local Docker stack](./docker/docker-compose.quickstart.yaml)**
>
