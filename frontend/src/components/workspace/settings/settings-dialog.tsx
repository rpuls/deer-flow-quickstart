...
const ProvidersSettingsPage = dynamic(
  () =>
    import("./providers-settings-page").then(
      (module) => module.ProvidersSettingsPage,
    ),
  { loading: SettingsPageLoading },
);
        ...
        <div className="grid min-h-0 flex-1 gap-4 md:grid-cols-[220px_minmax(0,1fr)]">
          ...
          <ScrollArea className="h-full min-h-0 rounded-lg border">
            <div className="space-y-8 p-6">
              ...
              {activeSection === "providers" && <ProvidersSettingsPage />}
